...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-sm">
                    <form action="crear_articulo.jsp" method="post">
                        <table class="table table-striped">

                            <thead>
                            <tr>
                            <center><h3>Nuevo Artículo</h3></center>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <p>
                            <tr>
                            <input type="text" class="form-control" id="unimed" name="unimed" placeholder="Unidad de medida">
                            </tr>
                            <p>
                            <tr>
                            ...
                            <p>
                            <tr>
                            <center><button type="submit" name="enviar" class="btn btn-primary">Guardar<i class="fa fa-floppy-o" aria-hidden="true"></i></button></center>
                            </tr>
         ...
         <%
            if (request.getParameter("enviar") != null) {
                ...
                try {
                    ...
                    st.executeUpdate("insert into articulo (descripcion,unimed,marca,modelo,presentacion,precio,estado) values('"+nombre+"','"+unimed+"','"+marca+"','"+modelo+"','"+presentacion+"','"+precio+"','A');");
